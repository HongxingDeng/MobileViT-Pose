...
class MobileVit_DWSConvBlock(nn.Module):
    """MobileViT block.
    ...
    def __init__(
        ...
        super(MobileVit_DWSConvBlock, self).__init__()
...
class MobileViT_DWSConv(BaseBackbone):
    """MobileViT backbone.
    ...
    def __init__(self,
        ...
        super(MobileViT_DWSConv, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        super(MobileViT_DWSConv, self).train(mode)
        self._freeze_stages()
