...
from .mobileNext import InvertedResidual_SGBlock
from .vision_transformer import TransformerEncoderLayer


class MobileVit_SGBlock(nn.Module):
    """MobileViT block.
    ...
    def __init__(
        ...
        super(MobileVit_SGBlock, self).__init__()
...
class MobileViT_SG(BaseBackbone):
    """MobileViT backbone.
    ...
    def __init__(self,
        ...
        super(MobileViT_SG, self).__init__(init_cfg)
    ...
    def make_mobilevit_layer(in_channels,
                             ...
                             expand_ratio=4):
        """Build mobilevit layer, which consists of one InvertedResidual_SGBlock and
        one MobileVitBlock.
        ...
        Args:
            ...
            stride (int): The stride of the first 3x3 convolution in the
                ``InvertedResidual_SGBlock`` layers.
            ...
            expand_ratio (int): adjusts number of channels of the hidden layer
                in ``InvertedResidual_SGBlock`` by this amount. Defaults to 4.
        """
        layer = []
        layer.append(
                InvertedResidual(
    ...
    def make_mobilenetv2_layer(in_channels,
                               ...
                               num_blocks,
                               expand_ratio=4):
        """Build mobilenetv2 layer, which consists of several InvertedResidual_SGBlock
        layers.
        ...
        Args:
            ...
            stride (int): The stride of the first 3x3 convolution in the
                ``InvertedResidual_SGBlock`` layers.
            num_blocks (int): The number of ``InvertedResidual_SGBlock`` blocks.
            expand_ratio (int): adjusts number of channels of the hidden layer
                in ``InvertedResidual_SGBlock`` by this amount. Defaults to 4.
        """
        layer = []
    ...
    def train(self, mode=True):
        super(MobileViT_SG, self).train(mode)
        self._freeze_stages()
