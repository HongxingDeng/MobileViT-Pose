...
class MobileVitBlock_DWS_SG(nn.Module):
    """MobileViT block.
    ...
    def __init__(
        ...
        super(MobileVitBlock_DWS_SG, self).__init__()
...
class MobileViT_DWS_SG(BaseBackbone):
    """MobileViT backbone.
    ...
    def __init__(self,
        ...
        super(MobileViT_DWS_SG, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        super(MobileViT_DWS_SG, self).train(mode)
        self._freeze_stages()
