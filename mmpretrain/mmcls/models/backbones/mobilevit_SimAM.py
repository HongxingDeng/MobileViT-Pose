...
from .mobilenet_v2 import InvertedResidual as InvertedResidual
...
class MobileVit_SimAMBlock(nn.Module):
    """MobileViT block.
    ...
    def __init__(
        ...
        super(MobileVit_SimAMBlock, self).__init__()
...
class MobileViT_SimAM(BaseBackbone):
    """MobileViT backbone.
    ...
    def __init__(self,
        ...
        super(MobileViT_SimAM, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        super(MobileViT_SimAM, self).train(mode)
        self._freeze_stages()
